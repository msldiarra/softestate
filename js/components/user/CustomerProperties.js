...
class CustomerProperties extends React.Component {
    ...
    render() {
        ...
        if(this.props.customer.user.properties.edges.length > 0) {

            properties = this.props.customer.user.properties.edges.map(function (edge) {
...
export default Relay.createContainer(CustomerProperties, {
